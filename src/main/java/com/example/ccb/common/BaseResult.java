...
import com.example.ccb.exception.IErrorCode;
...
public class BaseResult<T> {
    ...
    public static <T> BaseResult<T> failWithErrorCode(IErrorCode errorCode) {
        return new BaseResult<>(errorCode.getCode(), errorCode.getMessage(), null);
    }

    public static <T> BaseResult<T> failWithException(CustomizeException ex) {
        return new BaseResult<>(ex.getCode(), ex.getMessage(), null);
    }
